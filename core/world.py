...
class World:
    ...
    def create_initial_ants(self):
        # BUG CORREGIDO: antes se hacía append dos veces de cada hormiga,
        # resultando en 4 entradas pero solo 2 objetos (referencias duplicadas).
        # Ahora cada hormiga tiene su propio ID único.
